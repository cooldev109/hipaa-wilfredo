...
export async function generateReportApi(evaluationId, conditionBlocks, font, lang) {
  const response = await api.post('/reports/generate', { evaluationId, conditionBlocks, font, lang });
